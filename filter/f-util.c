...
struct f_inst *
f_new_inst(enum f_instuction_code fi_code)
{
  struct f_inst * ret;
...
struct f_inst *
f_new_inst_da(enum f_instuction_code fi_code, struct f_dynamic_attr da)
{
...
struct f_inst *
f_new_inst_sa(enum f_instuction_code fi_code, struct f_static_attr sa)
{
  struct f_inst *ret = f_new_inst(fi_code);
  ret->aux = sa.f_type;
  ret->a2.i = sa.sa_code;

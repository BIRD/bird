...
struct f_inst {		/* Instruction */
  ...
  enum f_instuction_code fi_code;
  u16 aux;
  union {
    int i;
    void *p;
...
struct f_inst *f_new_inst(enum f_instuction_code fi_code);
struct f_inst *f_new_inst_da(enum f_instuction_code fi_code, struct f_dynamic_attr da);
struct f_inst *f_new_inst_sa(enum f_instuction_code fi_code, struct f_static_attr sa);
